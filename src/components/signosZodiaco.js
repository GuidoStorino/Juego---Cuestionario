const signos = {
  ...
  Escorpio: {
    buenas: ["Intenso"],
    malas: ["Rencoroso"],
    graciosas: ["Te perdona… pero guarda capturas y las repasa antes de dormir"],
    completadas: [],
  },
    Sagitario: {
    buenas: ["Aventurero"],
    malas: ["Desapegado"],
    graciosas: ["Te besa, se ríe y te cuenta que se va a Tailandia mañana"],
    completadas: [], // para llevar cuenta
  },
  Capricornio: {
    buenas: ["Persistente"],
  ...
  Piscis: {
    buenas: ["Soñador"],
    malas: ["Confuso"],
    graciosas: ["Se enamora, se va, vuelve, llora, y te escribe una canción que ni él entiende"],
    completadas: [],
  }}
