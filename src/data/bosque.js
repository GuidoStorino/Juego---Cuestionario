...
arturo: {
 ...
 afuera_casa_te: {
  ...
  opciones: [
    ...
    {texto: "Las hojas doradas se van tornando de un color más amarillo hasta llegar a ser completamente verdes. Algunas, incluso, se posan en las ramas como si siempre hubieran estado allí. La lluvia cesa y crecen algunas flores. Caminás un poco y encontrás un campo primaveral.", requiere: "hierbas verdes", destino: "signosZodiaco"},
 ...
 signosZodiaco: {
  texto: "Tras unos cuantos pasos, te encontrás con una hippie",
  opciones: [
    ],
    id: "hippie_bosque"
 },
